...
class OrderedSet(MutableSet[KT], Generic[KT]):
    ...
    def __init__(self, iterable: Optional[Iterable[KT]]=None) -> None: ...
    def add(self, item: KT) -> None: ...
    def remove(self, item: KT) -> None: ...
    def discard(self, item: KT) -> None: ...
    def __iter__(self) -> Iterator[KT]: ...
    def __contains__(self, Any) -> bool: ...
...
class MultiValueDict(MutableMapping[KT, VT], Generic[KT, VT]):
    ...
    def get(self, key: KT, default: Optional[VT] = None) -> Optional[VT]: ...  # type: ignore
    def getlist(self, key: KT, default: Optional[List[VT]] = None) -> Optional[List[VT]]: ...
    def setlist(self, key: KT, list_: List[VT]) -> None: ...
    def setlistdefault(self, key: KT, default_list: Optional[List[VT]]=None) -> List[VT]: ...
    ...
    @overload
    def update(self, *args: Mapping[KT, VT], **kwargs: Iterable[Tuple[KT, VT]]) -> None: ...
